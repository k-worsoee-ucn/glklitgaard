...
<section class="glk-hero col-span-12 text-center text-4xl">
    <h1 class="col-span-12 mt-20 lg:text-6xl text-4xl">Tilbud</h1>
    <h1 class="col-span-12 lg:text-6xl text-4xl text-secondary-brand-color">Pinseferie</h1>
</section>
<div class="rating-sect col-span-12 -mt-10 py-20">
    <div class="lg:hidden grid grid-cols-12">
        ...
        $tilbud = new WP_Query(array(
            'posts_per_page' => -1,
            'post_type' => 'pinse-tilbud'
        ));
        if ($tilbud->have_posts()) {
        ...
        ?>
                <div class="col-span-12 col-start-1 grid grid-cols-12 mb-20">
                    ...
                    <div class="paper col-span-12 p-10 grid">
                        ...
                        <a class="knap bg-main-interaction-color px-10 py-2 rounded-full mx-auto font-bold text-lg" target="_blank" href="https://v3.onlinebooking.dk/v3GLKLIT?lang=DA">Book tilbudet</a>
                    </div>
                </div>
            <?php
            }
            ...
            <div class="col-span-12">
                <h2 class="text-4xl text-center">Ingen tilbud at vise</h2>
            </div>
        <?php
        }
        ...
        ?>
                    <div class="col-span-8 col-start-2 grid grid-cols-8">
                        ...
                        <div class="paper col-span-5 p-10">
                            ...
                            <p class="ml-16 mt-16 text-lg"><?php echo the_field("desc") ?></p>
                            <p class="ml-16 mb-16 mt-10 font-bold text-2xl text-right"><?php echo the_field("offer") ?></p>
                            <a class="!ml-64 knap " target="_blank" href="https://v3.onlinebooking.dk/v3GLKLIT?lang=DA"><button class="bg-main-interaction-color px-10 py-2 rounded-full mx-auto font-bold text-lg">Book tilbudet</button></a>
                        </div>
                    </div>
                <?php
                    $i = $i + 1;
