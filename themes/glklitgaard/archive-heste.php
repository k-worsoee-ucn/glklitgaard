...
<div class="bottom-cta col-span-12 py-32 -mt-5 z-20 grid grid-cols-12">
    <div class="col-start-1 col-span-7 grid grid-cols-3">
        <img src="<?php echo get_theme_file_uri("/assets/images/ctaimg1.png") ?>" alt="" class="bg-white pt-6 px-6 pb-40 w-8/12">
        <img src="<?php echo get_theme_file_uri("/assets/images/ctaimg2.png") ?>" alt="" class="bg-white pt-6 px-6 pb-40 w-8/12">
        <img src="<?php echo get_theme_file_uri("/assets/images/ctaimg3.png") ?>" alt="" class="bg-white pt-6 px-6 pb-40 w-8/12">
    </div>
    <div class="col-start-8 col-span-4 text-center">
